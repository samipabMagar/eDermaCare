...
export default function DashboardMessages() {
  ...
  return (
    <div className="space-y-4 px-4 py-4 sm:px-6">
      ...
      <div className="flex h-[calc(100vh-220px)] min-h-125 overflow-hidden rounded-2xl border border-slate-200 bg-white">
        <div
          ...
          <div className="border-b border-slate-200 p-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 py-2.5 pl-10 pr-3 text-sm outline-none focus:border-[#0F9EA5]"
              />
            </div>
          </div>
                ...
                return (
                  <button
                    ...
                    className={`w-full border-b border-slate-100 p-4 text-left transition hover:bg-slate-50 ${
                      isActive ? "bg-[#0F9EA5]/5" : ""
                    }`}
                  >
                    <div className="flex items-start gap-3">
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#0F9EA5]/10 text-sm font-semibold text-[#0F9EA5]">
                        {item.doctorName
                          .split(" ")
                          .map((chunk) => chunk[0])
                          .join("")
                      ...
                      {item.unread > 0 ? (
                        <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#0F9EA5] text-[10px] font-semibold text-white">
                          {item.unread}
                        </span>
                      ) : null}
                    </div>
          ...
          {!activeConversation ? (
            ...
            <>
              <div className="flex items-center gap-3 border-b border-slate-200 px-4 py-3">
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0F9EA5]/10 text-sm font-semibold text-[#0F9EA5]">
              ...
              <div className="border-t border-slate-200 bg-white p-3">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm outline-none focus:border-[#0F9EA5]"
                  />
                  <button
                    type="button"
                    onClick={handleSendMessage}
                    disabled={sending || !messageInput.trim()}
                    className="rounded-xl bg-[#0F9EA5] p-2.5 text-white transition hover:bg-[#0c878d] disabled:cursor-not-allowed disabled:opacity-70"
